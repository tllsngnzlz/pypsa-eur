...
rule build_population_layouts:
    input:
        ...
        cutout="cutouts/" + CDIR + config["atlite"]["default_cutout"] + "_" + config["snapshots"]["year"] + ".nc",
    output:
...
rule prepare_sector_network:
    ...
    input:
        ...
        **build_sequestration_potentials_output,
        ...
        profile_offwind_ac=RESOURCES + "profile_offwind-ac_{weather_year}.nc",
        profile_offwind_dc=RESOURCES + "profile_offwind-dc_{weather_year}.nc",
